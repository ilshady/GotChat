...
class ChatLogController: UIViewController  {
    ...
    let messageManager = MessageCollectionViewManager()
    ...
    private func setDelegates() {
        messageViewModel.messagesDelegate = self
        inputContainerView.inputTextView.delegate = self
        
        messagesCollectionView.dataSource = messageManager
        messagesCollectionView.delegate = messageManager
        }
...
extension ChatLogController: UserMessagesDelegate {
    func didUpdateMessages() {
        messageManager.messages = messageViewModel.messages
